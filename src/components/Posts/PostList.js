import { ThumbDownIcon, EyeIcon, ThumbUpIcon } from "@heroicons/react/solid";
...
const PostsList = () => {
  ...
  const { postList, loading, appError, serverError, likes, dislikes } = posts;
  const {
    categoryList,
    loading: catLoading,
                        ...
                        <div className="flex flex-row bg-gray-300 justify-center w-full  items-center ">
                          ...
                          <div className="flex flex-row  justify-center items-center ml-4 mr-4 pb-2 pt-1">
                            <div>
                              <ThumbDownIcon
                                onClick={() =>
                                  dispatch(toggleDislikeToPost(post?.id))
                                }
