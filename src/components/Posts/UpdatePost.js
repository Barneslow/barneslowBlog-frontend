...
const UpdatePost = (props) => {
  ...
  const { loading, appError, serverError, isUpdated } = postUpdate;
            ...
            <form onSubmit={formik.handleSubmit} className="space-y-6">
              ...
              <div>
                {loading ? (
                  <button
                    disabled
                    className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-grey-500"
                  >
                    Loading Please Wait
                  </button>
                ) : (
