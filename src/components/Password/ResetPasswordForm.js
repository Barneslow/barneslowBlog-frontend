...
import { resetPasswordTokenAction } from "../../store/passwordSlice";
...
const ResetPasswordForm = () => {
  ...
  const { loading, appError, serverError, passwordToken } = password;
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-green-700 text-center text-xl">
          {passwordToken && (
            <h3>
              Email is successfully sent to your email. Please verify within 10
              minutes
            </h3>
          )}
        </div>
